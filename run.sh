...
energies=(1 5 10 50 100 500 1000 5000 10000) # in MeV
...
mkdir /home/devbot/Geant4_Workspace/GermaniumDectector/data_rohith/

file_name="/home/devbot/Geant4_Workspace/GermaniumDectector/data_rohith/muon"$energ"MeV.txt"
#echo $file_name
